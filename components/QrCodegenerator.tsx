...
function QrCodegenerator() {
  // Aqui está o corpo da função do seu componente
  const [url, setUrl] = React.useState("");
  const [color, setColor] = React.useState("#ffffff");
  const [bgColor, setBgColor] = React.useState("#037fff");
  ...
  return (
    <div className="relative z-10 mx-8 flex max-w-[1200px] w-full min-h-[700px] h-full">
      <Card className="flex-1 flex flex-col w-full h-auto mx-auto bg-[#ecf7ff]/80 backdrop-blur-md shadow-sm border-2 border-white rounded-xl">
        <CardHeader>
        ...
        <CardContent className="flex-1">
          <div className="h-full flex flex-col md:flex-row gap-8">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="w-full border-2 border-white/70 focus:border-[#057fff] rounded-md outline-none focus-visible:ring-0 placeholder:text-gray-400"
                      />
                    </div>
                  </div>
                </TabsContent>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="w-full border-2 bg-transparent border-white/70 focus:border-[#057fff] rounded-md outline-none focus-visible:ring-0 placeholder:text-gray-400"
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        className="w-full border-2 bg-transparent border-white/70 focus:border-[#057fff] rounded-md outline-none focus-visible:ring-0 placeholder:text-gray-400 h-24 resize:none"
                      />
                    </div>

                    <Button
                      className="py-7 px-8 bg-[#037fff]  hover:bg-[#057fff]/90 font-bold rounded-full uppercase"
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Input
                        ...
                        value={color}
                        onChange={(e) => setColor(e.target.value)}
                        className="w-28 h-12 bg-transparent border-2 border-white/70 focus:border-[#057fff]/70 rounded-md outline-none focus-visible:ring-0 placeholder:text-gray-400"
                      />
                    </div>
                  </div>

                  {/* Coluna do Background Color */}
                  <div className="space-y-2 flex-1">
                    <Label
                      htmlFor="bgColor"
                      className="font-semibold text-[#057fff]"
            ...
            <div className="relative flex-1 bg-[#037fff] rounded-lg flex flex-col justify-center scroll-py-6">
              <span>
              ...
              <div id="qr-code" className="flex justify-center">
                <div className="relative">
                  <QRCodeSVG
                    ...
                    imageSettings={
                      logo
                        ? { src: logo, width: 50, height: 50, excavate: true } // Define size here
                        : undefined
                    }
                  />
